...
import { Heart, Coins, Star, ChevronDown, User, Sparkles } from "lucide-react"
  ...
  return (
    ...
    >
      ...
      {open && (
        ...
        >
          {/* Kullanıcı adı */}
          <div className="px-4 py-3" style={{ borderBottom: "1px solid rgba(188,19,254,0.1)" }}>
          ...
          <div
            ...
            style={{ color: "rgba(255,255,255,0.7)", borderBottom: "1px solid rgba(188,19,254,0.06)" }}
          >
            <div className="flex items-center gap-2.5">
              <span style={{ color: "#BC13FE" }}><Coins size={15} /></span>
              <span style={{ fontSize: 13, fontWeight: 600 }}>Tokens</span>
            </div>
            <span className="font-bold tabular-nums" style={{ fontSize: 13, color: "#BC13FE" }}>
              {stats?.tokenBalance ?? "—"}
            </span>
          </div>
          ...
          {/* Nav items */}
          <div className="py-1">
            {navItems.map(({ icon, label, value, color, href }) => (
              <Link
                key={label}
                href={href}
              ...
              >
                ...
                <span className="font-bold tabular-nums" style={{ fontSize: 13, color }}>
                  {value}
                </span>
              </Link>
            ))}
